...
import { DanceVisualizer, PhotoSlot, SwipeGallery, Typewriter, VideoSlot } from './components/Media'
import { TrueCrimeUnit } from './components/TrueCrime'
  ...
  return (
    <>
      ...
      <main className={entered ? 'page page-visible enhanced-page' : 'page'}>
        ...
        <section className="section-plum eras-section" id="eras">
          ...
          <div className="eras-experience">
            ...
            <Reveal className="era-stage" delay={180}>
              <DanceVisualizer active={activeEra === 0 || activeEra === 4 || activeEra === 5} />
        ...
        <TrueCrimeUnit onReward={triggerReward} />
